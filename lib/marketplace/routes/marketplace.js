...
class MarketplaceRoutes {
  ...
  async getSettings(req, res) {
    try {
      // Get rate limit info from internal tracking (no API call needed)
      const rateLimit = {
        limit: this.githubProxy.rateLimit.limit,
        remaining: this.githubProxy.rateLimit.remaining,
        reset: this.githubProxy.rateLimit.reset,
        resetDate: this.githubProxy.rateLimit.resetDate
      };
